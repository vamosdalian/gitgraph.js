...
`@vamosdalian/gitgraph-js` is meant to replace the `gitgraph.js` package. I will refer to `gitgraph.js` as v1 and `@vamosdalian/gitgraph-js` as v2.
...
```js
import { createGitgraph, templateExtend, TemplateName } from "@vamosdalian/gitgraph-js";
